  ...
  return (
    <div className="analytics-dash">
      <div className="analytics-dash__metrics">
        ...
        <MetricCard label="Executions" value={exec.started ?? 0} sub={`✓ ${exec.completed ?? 0} · ✕ ${exec.failed ?? 0}`} />
      ...
      <div className="analytics-dash__grid">
        <section className="analytics-panel">
          ...
          <p className="analytics-panel__hint">Avg execution {avgMs} ms · suspended {exec.suspended ?? 0}</p>
        </section>
        <section className="analytics-panel">
